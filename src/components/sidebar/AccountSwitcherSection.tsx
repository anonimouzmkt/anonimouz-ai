...
export function AccountSwitcherSection({ currentUserId, onAccountSwitch }: AccountSwitcherSectionProps) {
  ...
  return (
    <div className="px-2">
      ...
      >
        <SelectTrigger className="w-full bg-background text-sm py-2 transition-all duration-200 hover:translate-x-1 hover:bg-sidebar-accent/70 flex items-center gap-3 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-2">
